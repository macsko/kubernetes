...
func TestQueuedEntityInfo_HasPodsWithPendingPlugins(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			entity:   newQueuedPodGroupInfo(podGroup.DeepCopy()),
			expected: false,
		},
		{
			name: "pod group with pod without pending plugins",
			entity: func() *QueuedPodGroupInfo {
				pgqi := newQueuedPodGroupInfo(podGroup.DeepCopy())
		...
		},
		{
			...
			entity: func() *QueuedPodGroupInfo {
				pgqi := newQueuedPodGroupInfo(podGroup.DeepCopy())
				pgqi.AddPod(podWithPending1)
				pgqi.RemovePodGroup(nonExistentPG)
				return pgqi
			}(),
			expected: true,
		},
			...
			entity: func() *QueuedPodGroupInfo {
				...
				pgqi := &QueuedPodGroupInfo{
					PodGroupInfo: &PodGroupInfo{
						...
						Type:              fwk.CompositePodGroupKeyType,
						CompositePodGroup: cpgRoot,
						Children:          []*PodGroupInfo{childInfo},
					},
				}
				pgqi.AddPod(podLeaf1WithPending)
				pgqi.AddPod(podLeaf2WithPending)
				pgqi.RemoveCompositePodGroup(cpgChild)
				return pgqi
			}(),
			expected: false,
		},
			...
			entity: func() *QueuedPodGroupInfo {
				...
				pgqi := &QueuedPodGroupInfo{
					PodGroupInfo: &PodGroupInfo{
						...
						Type:              fwk.CompositePodGroupKeyType,
						CompositePodGroup: cpgRoot,
						Children:          []*PodGroupInfo{childCPGInfo, siblingPGInfo},
					},
				}
				pgqi.AddPod(podLeaf1WithPending)
				pgqi.AddPod(podChild1WithPending)
			...
			entity: func() *QueuedPodGroupInfo {
				...
				pgqi := &QueuedPodGroupInfo{
					PodGroupInfo: &PodGroupInfo{
						...
						Type:              fwk.CompositePodGroupKeyType,
						CompositePodGroup: cpgRoot,
						Children:          []*PodGroupInfo{childCPGInfo},
					},
				}
				pgqi.AddPod(podLeaf1WithPending)
				pgqi.RemoveCompositePodGroup(nonExistentCPG)
				return pgqi
			}(),
			expected: true,
		},
