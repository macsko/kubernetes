...
func TestGetDifferentUIDPreCheck(t *testing.T) {
	...
	pgWithTargetPod := &framework.QueuedPodGroupInfo{
		PodGroupInfo: &framework.PodGroupInfo{
			Namespace: pgWithTarget.Namespace,
			Name:      pgWithTarget.Name,
			Type:      fwk.PodGroupKeyType,
			PodGroup:  pgWithTarget,
		},
	}
	...
	pgWithoutTargetPod := &framework.QueuedPodGroupInfo{
		PodGroupInfo: &framework.PodGroupInfo{
			Namespace: pgWithoutTarget.Namespace,
			Name:      pgWithoutTarget.Name,
			Type:      fwk.PodGroupKeyType,
			PodGroup:  pgWithoutTarget,
		},
	}
